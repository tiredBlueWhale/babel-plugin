! function(t, e) {
    ...
    return function(t) {
        ...
        }).call(e, n(6), n(7), n(15).setImmediate)
    }, function(t, e, n) {
        "use strict";
        ...
        e.default = {
            amazon: o.default,
            github: r(n(18)).default,
            google: r(n(22)).default,
            facebook: s.default,
            instagram: r(n(23)).default,
            linkedin: r(n(25)).default
        }
    }, function(t, e) {
        function n() {
        ...
        f.default.config({
            ...
            return n = e = function(e) {
                ...
                return a(n, e), c(n, [{
                    ...
                    value: function() {
                        var t = this;
                        !this.state.isLoaded || this.state.isConnected || this.state.isFetching ? this.props.onLoginFailure(this.state.isLoaded && this.state.isConnected ? "User already connected" : this.state.isLoaded && this.state.isFetching ? "Fetching user" : this.state.isLoaded ? "Unknown error" : "SDK not loaded") : this.setState(function(t) {
                            return s({}, t, {
                                isFetching: !0
                            })
                        }, function() {
            ...
            v = function(t) {
                ...
                return a(e, t), s(e, [{
                    ...
                    value: function() {
                        ...
                        "google" === this.props.provider ? h.default.google.oldLoad(t, this.id, this.handleSocialLoginInvokeSuccess, this.handleSocialLoginInvokeFailure) : "facebook" === this.props.provider ? h.default.facebook.oldLoad(t) : "linkedin" === this.props.provider && h.default.linkedin.oldLoad(t)
                    }
                }, {
                    key: "getProfile",
                    value: function() {
            ...
            c = function(t) {
                ...
                return new o.default(function(t) {
                    ...
                    Array.isArray(n) ? s = s.concat(n) : "string" == typeof n && n && (s = s.concat(n.split(","))), s = s.reduce(function(t, e) {
                        return "string" == typeof e && -1 === t.indexOf(e) && t.push(e.trim()), t
                    }, []);
        ...
        }, n(16), e.setImmediate = setImmediate, e.clearImmediate = clearImmediate
    }, function(t, e, n) {
        (function(t, e) {
            ! function(t, n) {
                "use strict";
        ...
        var r = Object.assign || function(t) {
            ...
            c = function(t) {
                ...
                return new o.default(function(t) {
                    ...
                    var r = document.getElementsByTagName("script")[0],
                        i = document.createElement("script");
                    i.src = "//connect.facebook.net/en_US/sdk.js", i.id = "facebook-jssdk", window.fbAsyncInit = function() {
            ...
            u = function(t) {
                return new o.default(function(e, n) {
                    if (!t.authResponse) return n((0, a.rslError)({
                        provider: "facebook",
                        type: "auth",
                        description: "Authentication failed",
                        error: t
                    ...
                    switch (t.status) {
                        case "connected":
                            h().then(function(n) {
                                return e(r({}, n, t.authResponse))
                            });
                            break;
                        case "not_authorized":
                        case "unknown":
                            return n((0, a.rslError)({
                                provider: "facebook",
                                type: "auth",
            ...
            generateUser: function(t) {
                return {
                    ...
                    token: {
                        ...
                        expiresAt: (0, a.timestampFromNow)(t.expiresIn)
                    }
                }
            },
            load: c,
        ...
        var d = function(t) {
                ...
                return new o.default(function(t, o) {
                    ...
                    var a = (0, c.parseAsURL)(r),
                        d = ["user"];
                    if (Array.isArray(i) ? d = i : "string" == typeof i && i && (d = i.split(",")), d = d.reduce(function(t, e) {
                            return "string" == typeof e && -1 === t.indexOf(e) && t.push(e.trim()), t
        ...
        e.default = {
            ...
            generateUser: function(t) {
                var e = "",
                    n = t.getBasicProfile(),
                    r = t.getAuthResponse(!0),
                    i = new XMLHttpRequest;
                if (i.open("GET", "https://www.googleapis.com/oauth2/v1/userinfo?access_token=" + r.access_token, !1), i.send(null), 200 === i.status) {
                    var o = i.responseText;
                    e = JSON.parse(o).gender
                }
                return {
                    profile: {
                        id: n.getId(),
            ...
            login: c,
            logout: u,
            oldLoad: function(t, e, n, r) {
                var i = document.createElement("script");
                i.src = "https://apis.google.com/js/platform.js", i.id = "gapi-client", i.onload = function() {
                    window.gapi.load("auth2", function() {
                        window.gapi.auth2.getAuthInstance() || window.gapi.auth2.init({
                            client_id: t
                        }), window.gapi.auth2.getAuthInstance().attachClickHandler(e, {}, n, r)
                    })
                }, 0 === document.getElementsByTagName("script").length ? document.appendChild(i) : document.getElementsByTagName("script")[0].parentNode.appendChild(i)
            }
        }
    }, function(t, e, n) {
        "use strict";
        ...
        e.default = {
            ...
            oldLoad: function(t) {
                var e = "li-client",
                    n = document.getElementsByTagName("script")[0],
                    r = void 0;
                document.getElementById(e) || (r = document.createElement("script"), r.id = e, r.src = "//platform.linkedin.com/in.js?async=true", r.onload = function() {
                    window.IN.init({
                        api_key: t,
                        authorize: !0
                    })
